...
public class Principal {
    ...
    private SerieRepository repositorio = null;
...
//                .findFirst();
    ...
    private void buscaSeriePorCategoria(){
        ...
        System.out.println("Digite o genero para ser buscado: ");
        var genero = leitura.nextLine();
        Categoria categoria = Categoria.fromPortugues(genero);
        List<Serie> seriesGenero = repositorio.findByGenero(categoria);

        if(!seriesGenero.isEmpty()){
            System.out.println("\nSéries de categoria " + genero);
            seriesGenero.forEach(System.out::println);
        } else{
            System.out.println("\nNenhuma série encontrada no banco para esse gênero");
        }
    ...
    private void buscaMaxTempAcimaMedia(){

        System.out.println("Insira o maximo de temporadas a ser buscada");
        var maxTemp = leitura.nextInt();
        leitura.nextLine();
        System.out.println("Insira o corte de avaliacao para serie");
        var corteAvaliacao = leitura.nextDouble();
        leitura.nextLine();

//        List<Serie> seriesTempoAvaliacao = repositorio.
//                findByTotalTemporadasLessThanEqualAndAvaliacaoGreaterThanEqual(
//                        maxTemp,
//                        corteAvaliacao);

        List<Serie> seriesTempoAvaliacao = repositorio
                .seriesPorTemporadaEAvaliacao(maxTemp, corteAvaliacao);

        seriesTempoAvaliacao.forEach(System.out::println);

    }

    private void buscarEpisodioPorTrecho(){

        System.out.println("Qual o episodio para a busca?");
    ...
    private void topEpisodiosPorSerie(){
        ...
        if(serieBusca.isPresent()){
            ...
            System.out.println("Indique um top para a busca");
            var top = leitura.nextInt();
            leitura.nextLine();
            List<Episodio> topEpisodios = repositorio.topEpisodioSerie(serie, top);
    ...
    private void buscarEpisodiosAposData(){
        ...
        if(serieBusca.isPresent()){
            ...
            List<Episodio> episodiosAno = repositorio.
                                    episodiosPorSeriaEAno(serie, anoLancamento);
